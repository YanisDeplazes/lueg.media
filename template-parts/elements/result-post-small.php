...
<article id="<?php echo esc_attr( get_post_type() ); ?>-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry content">
		<h2 class="entry-title has-m-font-size"><a href="<?php echo esc_url( get_permalink() ); ?>"><?php echo esc_html( get_the_title() ); ?></a></h2>
		<a href="<?php echo esc_url( get_permalink() ); ?>" class="permalink"><?php echo esc_html( __( ' →', 'default' ) ); ?></a>
	</div><!-- .entry content -->
</article>
